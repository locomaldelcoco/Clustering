...
public class BFSTest {
	...
	public void grafoUnVerticeTest() {
		Grafo g = new Grafo();
		g.agregarVertice(new Vertice(0, 0));
	...
	public void grafoDosVerticesAisladosTest() {
		Grafo g = new Grafo();
		g.agregarVertice(new Vertice(0, 0));
		g.agregarVertice(new Vertice(1, 1));
	...
	public void grafoDosVerticesConexoTest() {
		Grafo g = new Grafo();
		g.agregarVertice(new Vertice(0, 1));
		g.agregarVertice(new Vertice(0, 2));
		g.agregarArco(0, 1, 2);;
		assertTrue(BFS.esConexo(g));
	}
	...
	private Grafo inicializarGrafoInconexo() {
		...
		g.agregarVertice(new Vertice(0, 1));
		g.agregarVertice(new Vertice(0, 2));
		g.agregarVertice(new Vertice(0, 3));
		g.agregarVertice(new Vertice(0, 4));
		g.agregarVertice(new Vertice(0, 5));
		g.agregarVertice(new Vertice(0, 6));
		g.agregarVertice(new Vertice(0, 7));
		g.agregarArco(0, 1, 1);
		g.agregarArco(0, 2, 1);
		g.agregarArco(1, 2, 1);
		g.agregarArco(1, 3, 1);
